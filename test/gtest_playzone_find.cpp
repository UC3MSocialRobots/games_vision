...
TEST(TestSuite, white_img) { test_fail(cv::Mat3b(640, 480, cv::Vec3b(255, 255, 255)),
                                       PlayzoneFind::FAILURE_NO_GOOD_COMP); }
TEST(TestSuite, arnaud001) { test_fail(cv::imread(PLAYZONE_DIR + "balloon.png", CV_LOAD_IMAGE_COLOR),
                                       PlayzoneFind::FAILURE_NO_GOOD_COMP); }

////////////////////////////////////////////////////////////////////////////////
inline void test_success(const std::string filename = PLAYZONE_DIR + "pz05.jpg") {
  if (!vision_utils::rosmaster_alive()) return;
...
TEST(TestSuite, pz01) { test_success(PLAYZONE_DIR + "pz01.jpg"); }
TEST(TestSuite, pz08) { test_success(PLAYZONE_DIR + "pz08.jpg"); }
TEST(TestSuite, pz09) { test_success(PLAYZONE_DIR + "pz09.jpg"); }
TEST(TestSuite, pz10) { test_success(PLAYZONE_DIR + "pz10.jpg"); }
TEST(TestSuite, pz11) { test_success(PLAYZONE_DIR + "pz11.jpg"); }
TEST(TestSuite, pz12) { test_success(PLAYZONE_DIR + "pz12.jpg"); }
TEST(TestSuite, pz40) { test_success(PLAYZONE_DIR + "pz40.jpg"); }
TEST(TestSuite, tictactoe_frame) { test_success(GAMES_DATA_DIR + "tictactoe/sample_frame.jpg"); }
// fails
TEST(TestSuite, pz39) { test_fail(cv::imread(PLAYZONE_DIR + "pz39.jpg"),
